...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ID,kolicina" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
        <Columns>
            ...
            <asp:ButtonField ButtonType="Button" CommandName="Select" HeaderText="Stavi u korpu" ShowHeader="True" Text="Select" />
            
        </Columns>
    </asp:GridView>
    <br />
    <asp:Button ID="Btn_Zavrsi" runat="server" Text="Zavrsi kupovinu" OnClick="Btn_Zavrsi_Click" />
</asp:Content>